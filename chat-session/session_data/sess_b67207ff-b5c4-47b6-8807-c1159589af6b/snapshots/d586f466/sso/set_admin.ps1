...
Invoke-RestMethod -Method Put -Uri "https://api.github.com/repos/$owner/$repo/collaborators/$u" -Headers $headers -ContentType 'application/json' -Body '{"permission":"admin"}' | Out-Null
