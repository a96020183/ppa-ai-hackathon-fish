...
export const flow = [
  ...
  { id: 'softland', label: '④ 答錯 → 45秒軟著陸', hint: '內容農場鉤子 · 試吃' },
  { id: 'radar', label: '⑤ AI 主動診斷雷達', hint: '主線 · 依分類' },
  { id: 'recommend', label: '⑥ AI 助教推薦', hint: '去重 + 熱門加乘' },
  { id: 'multimodal', label: '⑦ 多模態學習', hint: '影音 / 電子書 / Podcast' },
  { id: 'profile', label: '⑧ 個人主頁', hint: '分類雷達總覽 + 徽章' },
  { id: 'pet', label: '⑨ 知識精靈 + 戰隊', hint: '養成 / 徽章 / 敲朋友' },
]
